...
<div id="page" class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <?php if ($main_menu): ?>
    <nav id="main-menu" class="main-menu-wrapper clearfix">
      <div class="g-all-row">
        <?php if ($main_menu): ?>
  ...
  <?php if ($page['navigation'] || $page['navigation_first'] || $page['navigation_second']): ?>
    <div class="navigation-columns-wrapper clearfix">
        <div class="navigation g-all-row">
        <div class="navigation-inner-wrapper clearfix">
  ...
  <section id="main">
    ...
    <div class="content-wrapper clearfix">
      <div id="content" class="content g-all-row">
    ...
    <?php if ($page['postscript_first'] || $page['postscript_second'] || $page['postscript_third'] || $page['postscript_fourth']): ?>
      <div class="postscript-wrapper clearfix">
        <div class="postscript g-all-row">
...
<footer id="footer">
  ...
  <?php if ($page['footer_first'] || $page['footer_second'] || $page['footer_third'] || $page['footer_fourth']): ?>
    <div class="footer-columns-wrapper">
      <div class="footer-columns g-all-row">
